...
This takes **~12 minutes on GTX 1060** (~3 minutes on T4). It:
1. Downloads today's data from yfinance
2. Runs Kronos-small on all 49 Thai tickers
3. Generates a trade ticket

You'll see output like:
```
[06:30] STEP1: download_data.py
[06:31] STEP1_OK
[06:31] STEP2: forecast generation
[06:43] STEP2_OK
[06:43] STEP3: trade ticket generation
[06:43] STEP3_OK: 2 exits, 3 buys
[06:43] PIPELINE_OK
```
...
Add this to your crontab for automatic 06:30 BKK execution:
...
## 3. Daily Morning Routine (15 min)

### 06:45 — Open the Dashboard

Go to `http://localhost:5555`. The forecasts were already generated by cron at 06:30.
