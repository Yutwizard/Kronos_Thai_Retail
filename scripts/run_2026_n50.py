"""2026 precompute + walkforward with n_samples=50 (offline)."""
...
c = BacktestConfig(start_date='2026-01-01', end_date='2026-05-30',
                   lookback=400, pred_len=20, n_samples=50,
                   position_sizing='equal', max_positions=5,
                   min_ticker_history=20)

print(f'2026: {len(tickers)} tickers, n_samples=50, offline', flush=True)
t0 = time.time()
...
o = Path('data/backtest_results/thai_equity_2026_n50_full')
