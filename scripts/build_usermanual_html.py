...
<style>
  ...
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  body {{ font-family: 'Inter', -apple-system, sans-serif; color: #1a1a2e; background: #f5f6fa; line-height: 1.6; }}
  ...
  pre {{ padding: 14px; overflow-x: auto; border-left: 3px solid #2e86c1; margin: 10px 0; }}
