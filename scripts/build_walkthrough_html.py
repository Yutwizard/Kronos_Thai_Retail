...
<div class="toc-card">
  ...
  <ol>
    ...
    <li><a href="#day9">Day 9 &mdash; Signal Reversal (TENCENT80)</a></li>
...
<div class="card" id="start">
  ...
  <table>
    ...
    <tr><td>TENCENT80.BK</td><td>DR</td><td>120,000</td><td>12%</td><td>25.40 THB</td></tr>
    <tr><td>ASML01.BK</td><td>DR</td><td>100,000</td><td>10%</td><td>19.80 THB</td></tr>
    <tr style="font-weight:700;background:#f0f4f8;"><td colspan="2">Total</td><td>1,000,000</td><td>100%</td><td></td></tr>
  </table>
  <p style="font-size:0.85rem;color:#7f8c8d;">Holdings: PTT, KBANK, TENCENT80 (DR), ASML80 (DR) | Cash: 60% | Invested: 40%. THB values at book cost unless noted.</p>
</div>
...
GREEN BULLISH (top 10):
  ...
  TENCENT80.BK Tencent (DR) 25.40   +1.30%   8.5%   🟢    up
...
Median band: 16%  |  Green signals: 6  |  Red flags: 8</div>
  <p><strong>Signal checks:</strong> PTT (+2.10%, 🟢) &rarr; hold. TENCENT80 (+1.30%, 🟢) &rarr; hold. ASML01 (+3.20%, 🟡) &rarr; hold at half-conviction. KBANK not in bearish list &rarr; hold.</p>
...
<div class="day-title">TENCENT80 Flips Bearish</div>
<div class="brief-box">GREEN BULLISH:
...
RED BEARISH:
  TENCENT80.BK Tencent (DR) 25.10  -0.80%   7.0%   🟢   down   &lt;- NEW</div>
  <div class="alert">
    <div class="alert-title">TENCENT80 flips bearish. You hold TENCENT80.</div>
    <p>Band: 7.0% (🟢 NARROW). Net return if held: -0.80% - 0.536% = <strong>-1.34%</strong>. Same-day urgent exit.</p>
    <p>Sell position at ~25.10 THB &rarr; <strong>118,379 THB</strong> net after friction. Cash becomes 701,789 THB (70%). PTT holds at 100,000 THB (10%). ASML01 holds at 100,000 THB (10%).</p>
  </div>
  <p style="font-size:0.85rem;color:#7f8c8d;">The monthly rebalance plan is updated: CHG, HMPRO, SCC on buy list; TENCENT80 removed (exited).</p>
</div>
...
RED-FLAGGED: ASML01, TENCENT80, DELTA, KBANK... (42 tickers)
...
Median band: 33% (Day 11: 35%, Day 12: 32%, Day 13: 33%)</div>
  ...
  <p><strong>ASML01 half-exit:</strong> Sell 50% of book position. Net: +49,550 THB. ASML01 now 5%.</p>
  <p>Cash: 701,789 + 50,848 + 49,550 = <strong>801,626 THB (80%)</strong>. PTT: 5%. ASML01: 5%. Total: 901,626 THB.</p>
</div>
...
<div class="day-title">Regime Change &amp; Monthly Plan Update</div>
  ...
  <table>
    ...
    <tr><td>Thai equity</td><td>5% (PTT only)</td><td>65%</td><td style="color:#e74c3c;">Under-allocated</td></tr>
    <tr><td>DR</td><td>5% (ASML01 only)</td><td>15%</td><td style="color:#e74c3c;">Under-allocated</td></tr>
    <tr><td>Cash</td><td>90%</td><td>20%</td><td style="color:#e74c3c;">Over-allocated</td></tr>
  </table>
  <p><strong>Monthly buy plan for Day 21:</strong> GLOBAL 10%, SCC 10%, CHG 5%, PTT add 5%, HMPRO 5% (all Thai equity). ASML01 hold at 5% (DR still 🟡 down).</p>
</div>
...
<div class="card" id="day21">
  ...
  <table>
    ...
    <tr><td>ASML01.BK</td><td>50,000</td><td>25,000</td><td>2.5%</td></tr>
  ...
  <div class="highlight-blue">
    <strong>Key lesson:</strong> The -9.97% drawdown was driven by the 3-day streak trigger (forced partial exits into a volatile market), not by model signal error. KBANK and TENCENT80 exits were correct (both remained bearish for 17+ days after exit). ASML01 exit was forced by the streak rule, not by ASML01's individual signal. The month-end rebalance restores Thai equity positioning to 25% of portfolio.
  </div>
  <div class="highlight">
